...
- **Canonical report shape:** the emitted VERIFICATION.md follows `@C:/Users/UMANG JAISWAL N/OneDrive/Desktop/Sih-2026New/.claude/gsd-core/templates/verification-report.md` — the template whose Guidelines and row shapes `src/uat.cts` treats as canonical when consuming verification output.
